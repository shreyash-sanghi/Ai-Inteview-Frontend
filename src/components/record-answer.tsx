...
import {createAnswer,getPerticularAnswer} from "../api/mainApi/userAnswer-api.js"
...
export const RecordAnswer = ({
  ...
  const saveUserAnswer = async () => {
    ...
    try {
       const data1 = {userId:userId,question:currentQuestion};
      const querySnap = await getPerticularAnswer(data1);

      if (querySnap?.data?.data == true) {
