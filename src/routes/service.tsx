    ...
    <div className="relative">
        <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
            <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
                ...
                <div>
                    <div>
                        <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-gray-400">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <a className="inline-flex rounded-lg bg-gray-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 "
                                href="/login">
                                Learn More
                            </a>
                        </div>
